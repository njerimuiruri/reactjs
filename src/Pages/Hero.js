                                    ...
                                    <div class="carousel-inner border-radius-lg h-100">
                                        <div class="carousel-item h-100 active" >
                                            ...
                                            <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                                ...
                                                <h5 class="text-white mb-1">Latest</h5>
                                            </div>
                            ...
                            <div class="card ">
                                <div class="card-header pb-0 p-3">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="mb-2">Sales in a week</h6>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="w-30">
                                                    <div class="d-flex px-2 py-1 align-items-center">
                                                        <div>
                                                            <img src={"./Image/6kgafrigas.PNG"} width="20" height="20" />
                                                        </div>
                                                        <div class="ms-4">
                                                            <p class="text-xs font-weight-bold mb-0">Gas type:</p>
                                                            <h6 class="text-sm mb-0">6Kg</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="w-30">
                                                    <div class="d-flex px-2 py-1 align-items-center">
                                                        <div>
                                                            <img src="./Image/13kgkgas.PNG" width="20" height="20" />
                                                        </div>
                                                        <div class="ms-4">
                                                            <p class="text-xs font-weight-bold mb-0">Gas type:</p>
                                                            <h6 class="text-sm mb-0">13Kg</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h6 class="mb-1 text-dark text-sm">Afrigas</h6>
                                                    <span class="text-xs">25 in stock <span class="font-weight-bold">46+ sold</span></span>
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                        ...
                                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h6 class="mb-1 text-dark text-sm">K-gas</h6>
                                                    <span class="text-xs">23 in stock, <span class="font-weight-bold">4 sold</span></span>
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                                        ...
                                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="text-xs">25 in stock, <span class="font-weight-bold">20+ sold closed</span></span>
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                                        ...
                                        <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h6 class="mb-1 text-dark text-sm">Oillibya</h6>
                                                    <span class="text-xs font-weight-bold">40+ sold </span>
                                                </div>
                                            </div>
                                            <div class="d-flex">
                                                <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
